    ...
    <div class="container-all">
        <div class="container-portada">
            <div class="container-eslogan">
                <h2>Tú espacio para sanar y crecer</h2>
            </div>
            <div class="container-intro">
    <div class="parrafo-uno">
        <p>Creemos que la salud mental es un pilar fundamental para una vida plena y satisfactoria. Nuestro objetivo es ofrecerte un espacio seguro y acogedor donde puedas encontrar información confiable, recursos valiosos y apoyo en tu camino hacia el bienestar emocional.</p>
        <a href="encuesta1.php" >
        <button class="btn-encuesta">Encuesta 1</button>
    </a>
    </div>
    <div class="parrafo-dos">
        <p>Entendemos que cada persona es única y, por tanto, sus necesidades y procesos también lo son. Aquí encontrarás artículos, guías y herramientas diseñadas para ayudarte a comprender mejor tu propia salud mental, manejar el estrés diario y fomentar hábitos saludables que promuevan tu equilibrio emocional.</p>
        <button class="btn-encuesta">Encuesta 2</button>
    </div>
</div>
            </div>
        </div>
